...
ICON = pygame.image.load('resources\SPRITES\icon.png')

def welcomeScreen():

    #IT WIll Show Welcome Screen TO user to make the game more interactive and interesting
    mixer.music.stop()
    mixer.music.load('resources/AUDIO/BGMUSIC.wav')
    mixer.music.play()
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] = pygame.transform.scale(pygame.image.load('resources\SPRITES\message.png').convert_alpha(), (250, 500))
